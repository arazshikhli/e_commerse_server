...
const addRatingToProduct = async (req, res) => {
  ...
  console.log("ProductId",productId);
    ...
    try {
      ...
      const newAverageRating = (product.rating.average * product.rating.totalRatings + rating) / newTotalRatings; // Рассчитываем новое среднее
      ...
      return res.status(200).json({ message: 'Rating added successfully', updatedProduct: product });
